...
public class VistaMesociclo extends javax.swing.JFrame {

    public VistaMesociclo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaMesociclo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaMesociclo().setVisible(true);
            }
        });
    }
